...
consists in classifying as foreground or background every single pixel belonging to a frame of a video sequence. At the end, the algorithm take as input a video and output a binary mask, where 1s are foreground pixels and 0s background pixels.
